...
class MechanicPrivacyPolicyScreen extends StatefulWidget {
  const MechanicPrivacyPolicyScreen({super.key});

  @override
  State<MechanicPrivacyPolicyScreen> createState() => _PrivacyPolicyScreenState();
}

class _PrivacyPolicyScreenState extends State<MechanicPrivacyPolicyScreen> {
